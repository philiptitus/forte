...
function Reg () {
  ...
  const handleSigninWithGoogle = async (response)=>{
    ...
    const server_res= await axios.post("http://localhost:8000/api/users/google/", {'access_token':payload})
  ...
  useEffect(() => {
    ...
    google.accounts.id.initialize({
      client_id:'396214558664-ghb7mkocs7p3t17ujemjklstu6p3m1vn.apps.googleusercontent.com',
