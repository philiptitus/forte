...
export default function ScrollableTabsButtonAuto({ id, showReviews = false , showRequests = false, showMaintenance = true, showComplain=true, showPopUp=false , showSearch = false }) {
